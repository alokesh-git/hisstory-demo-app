...
const Header = () => {
  ...
  return (
    <div style={{background: `url("./img${router.route}.png")`}} className="w-full z-40 sticky top-0 lg:h-[10%] h-[10%] rounded-b-2xl shadow-md shadow-zinc-900 lg:p-5 py-5  flex flex-row justify-evenly lg:justify-end items-center">
